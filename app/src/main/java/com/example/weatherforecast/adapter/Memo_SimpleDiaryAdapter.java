...
public class Memo_SimpleDiaryAdapter extends RecyclerView.Adapter<Memo_SimpleDiaryAdapter.ViewHolder> {
    ...
    public Memo_SimpleDiaryAdapter(List<Diary> diaryList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        //绑定事件
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_memo_simple_diary, parent, false);

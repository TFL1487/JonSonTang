...
public class Memo_EditDiaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memo_edit_diary);
        ...
        //相册内选择图片
        edit_album.setOnClickListener(new Memo_NoDoubleClickListener() {
            @Override
            public void onNoDoubleClick(View v) {
                ...
                if(ContextCompat.checkSelfPermission(Memo_EditDiaryActivity.this,Manifest.permission.READ_EXTERNAL_STORAGE)!=
                        PackageManager.PERMISSION_GRANTED ||
                        ContextCompat.checkSelfPermission(Memo_EditDiaryActivity.this,Manifest.permission.WRITE_EXTERNAL_STORAGE)!=
                                PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(Memo_EditDiaryActivity.this,new String[]{
        ...
        asr = EventManagerFactory.create(Memo_EditDiaryActivity.this,"asr");//注册自己的输出事件类
        ...
        edit_speech.setOnClickListener(new NoDoubleClickListenerToSpeech() {
            ...
            protected void onNoDoubleClick(View v) {
                ...
                if(flagOfEditSpeech%2==0){
                    Toast.makeText(Memo_EditDiaryActivity.this,"正在语音识别(仅支持短语音识别20s)",Toast.LENGTH_SHORT).show();
                    speechRecognitionStart();
                    edit_speech.setImageResource(R.drawable.edit_end);
                    flagOfEditSpeech+=1;
                }else {
                    Toast.makeText(Memo_EditDiaryActivity.this,"语音识别结束",Toast.LENGTH_SHORT).show();
        ...
        //清空文本内容
        edit_clear.setOnClickListener(new Memo_NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                showClear();
            }
    ...
    public void showCalendar(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Memo_EditDiaryActivity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    public void showTime(){
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(Memo_EditDiaryActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void showMood(){
        View moodDialogView=View.inflate(Memo_EditDiaryActivity.this,R.layout.list_memo_mood,null);
        //创建自定义选择框
        final AlertDialog.Builder moodDialogBuilder = new AlertDialog.Builder(Memo_EditDiaryActivity.this);
        moodDialogBuilder
    ...
    private void showCover(){
        View coverDialogView=View.inflate(Memo_EditDiaryActivity.this,R.layout.item_memo_cover,null);
        //创建自定义选择框
        final AlertDialog.Builder coverDialogBuilder = new AlertDialog.Builder(Memo_EditDiaryActivity.this);
        coverDialogBuilder
    ...
    private void showClear(){
        View clearDialogView=View.inflate(Memo_EditDiaryActivity.this,R.layout.memo_clear_edit_text,null);
        //创建自定义选择框
        final AlertDialog.Builder clearDialogBuilder = new AlertDialog.Builder(Memo_EditDiaryActivity.this);
        clearDialogBuilder
    ...
    private void showSave(){
        View saveDialogView=View.inflate(com.example.weatherforecast.activity.Memo_EditDiaryActivity.this,R.layout.memo_save_edit_text,null);
        //创建自定义选择框
        final AlertDialog.Builder saveDialogBuilder = new AlertDialog.Builder(Memo_EditDiaryActivity.this);
        saveDialogBuilder
        ...
        save_true.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(result){
                    ...
                    saveDialog.dismiss();
                    //跳转回主页
                    Intent intent=new Intent(Memo_EditDiaryActivity.this,Memo_main_Activity.class);
                    startActivity(intent);
                    finish();
                }else{
                    //保存失败，提醒用户标题和内容不能全为空
                    Toast.makeText(Memo_EditDiaryActivity.this,"标题和日记内容不能全为空哦",Toast.LENGTH_SHORT).show();
                    saveDialog.dismiss();
                }
            }
        });
    ...
    private boolean saveDiary(){
        ...
        //提示用户标题和正文内容不能都为空
        if (titleText.equals("") && contentText.equals(new WMEditText(Memo_EditDiaryActivity.this).getHtml())) {
            return false;
        } else {
    ...
    /**
     * 设置系统状态栏的颜色
     * @see Memo_main_Activity#setStatusBarColor(Activity, int)
     */
    ...
    private void showBack(){
        View backDialogView=View.inflate(Memo_EditDiaryActivity.this,R.layout.item_memo_back,null);
        //创建自定义选择框
        final AlertDialog.Builder backDialogBuilder = new AlertDialog.Builder(Memo_EditDiaryActivity.this);
        backDialogBuilder
            ...
            case OPEN_ALBUM:
                if (resultCode == RESULT_OK) {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(Memo_EditDiaryActivity.this, "图片插入失败", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
            default:
        ...
        switch (requestCode){
            case 1:
                if(grantResults.length>0&&grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(Memo_EditDiaryActivity.this,"Failed to open it!",Toast.LENGTH_LONG).show();
                }
            default:
                break;
        }
